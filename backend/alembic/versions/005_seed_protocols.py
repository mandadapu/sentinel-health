"""Seed clinical_protocols with development data.

Inserts hospital-curated and FHIR-public protocol documents with
zero-vector embeddings (1024-dim) for local development.  Production
embeddings are generated at ingestion time by the embedding service.
...
def downgrade() -> None:
    op.execute("DELETE FROM clinical_protocols WHERE effective_date = '2024-01-01' AND version = 1;")
